...
- [ ] 1.3 Delete button enabled and styled destructively on detail page
- [ ] 1.4 Confirmation dialog shows batch name and warns about irreversibility
- [ ] 1.5 Confirming deletion removes batch and diary entries, redirects to /batches
- [ ] 1.6 Cancel closes dialog without side effects
- [ ] 1.7 Non-existent or other-user batch returns 404
- [ ] 1.8 Unauthenticated DELETE returns error
...
- [ ] 2.3 Duplicate button visible on detail page and navigates correctly
- [ ] 2.4 Create form pre-filled with parameters and ingredients from source batch
- [ ] 2.5 Name and date fields are blank on pre-filled form
- [ ] 2.6 Submitting pre-filled form creates new batch with fresh diary
- [ ] 2.7 Graceful fallback to empty form when source batch not found
