...
- [ ] 1.1 Migration applies cleanly on local Supabase
- [ ] 1.2 Existing batch rows retain correct sugar values in new columns
- [ ] 1.3 Ingredients JSONB no longer contains sugar entries or type/sort_order keys

#### Manual

- [ ] 1.4 Query a batch in Supabase Studio and confirm new columns + cleaned ingredients

### Phase 2: Application Code

#### Automated

- [ ] 2.1 TypeScript type-checks pass
- [ ] 2.2 All tests pass
- [ ] 2.3 No lint errors
- [ ] 2.4 Build succeeds
...
- [ ] 2.5 Create a new batch — sugar cards appear, Calculate populates them
- [ ] 2.6 Edit an existing batch — sugar values load correctly
- [ ] 2.7 Sweetness dry/non-dry toggle shows/hides sweetness card
- [ ] 2.8 Overall form layout visually unchanged
