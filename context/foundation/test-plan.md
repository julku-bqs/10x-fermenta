...
| 5   | E2E UI-wiring coverage                | Prove browser-level UI wiring for three narrow risks: validation-warning display/dismiss/non-persistence, diary regenerate preserve-and-rebuild, and save/cancel/reload round-trip including ingredient order | #2, #3, #7    | e2e                | not started   | —                                            |
