...
| 2 | Data integrity and interaction | Prove ingredient→calculation data flow, API input validation, and sugar field save/cancel/reload lifecycle preserve correct data | #4, #5, #7 | unit + integration | implementing | context/changes/testing-data-integrity/ |
